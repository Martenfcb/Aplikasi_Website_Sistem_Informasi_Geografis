...
<body>
    ...
    <div class="container col-md-6 mt-4">
        <h1>Tambah Data Kelurahan/Nagari</h1>
        <form action="" method="post" role="form" enctype="multipart/form-data">
            <div class="form-group">
                <label>Nama Kelurahan/Nagari</label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ing" required="" class="form-control">
            </div>
            <div class="form-group">
        ...
        if (isset($_POST['submit'])) {
            ...
            // Simpan data lokasi
            $query_insert_data = "INSERT INTO lokasi (nama, lat, ing, des, image) VALUES ('$nama', '$lat', '$ing', '$des', '$image')";
    ...
    <script>
        ...
        var map = L.map('map').setView([-1.8104143125690726, 100.99281750200439], 11);
        ...
        if (isset($data)) {
            foreach ($data as $row) {
                ...
                echo "L.marker([$lat, $lng]).addTo(map)
                    .bindPopup(\"<h4>$nama</h4><p>$des</p> <img src='img/$image' style='width: 100px;'>\");";
            }
        }
        ?>
    </script>
