...
<body>
    <div class="container col-md-6 mt-4">
        <h1>Edit Data Penduduk Muara Gadang Air Haji</h1>
        <?php
        include('koneksi.php');
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $query = "SELECT * FROM penduduk_muara_gadang WHERE id = $id";
        ...
        if (isset($_POST['submit'])) {
            ...
            $query_update = "UPDATE penduduk_muara_gadang SET 
                nomor_kk='$nomor_kk', 
            ...
            if ($result_update) {
                echo "<script>alert('Data berhasil diupdate.');window.location='status_penduduk_muara_gadang_air_haji.php';</script>";
            } else {
