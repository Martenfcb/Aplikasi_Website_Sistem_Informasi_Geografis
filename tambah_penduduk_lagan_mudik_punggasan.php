...
<body>
    ...
    <div class="container col-md-6 mt-4">
        ...
        if (isset($_POST['submit'])) {
            ...
            $query_insert_data = "INSERT INTO penduduk_lagan_mudik (nomor_kk, kepala_keluarga, nik, jumlah_anggota, jenis_kelamin, alamat, kampung, rt, rw, tanggal_terdaftar, lat, lng, image) VALUES ('$nomor_kk', '$kepala_keluarga', '$nik', '$jumlah_anggota', '$jenis_kelamin', '$alamat', '$kampung', '$rt', '$rw', '$tanggal_terdaftar', '$lat', '$lng', '$image')";
            $result_insert_data = mysqli_query($db, $query_insert_data) or die(mysqli_error($db));

            echo "<script>alert('Data berhasil disimpan.');window.location='status_penduduk_lagan_mudik_punggasan.php';</script>";
        }
        ?>
    </div>
