...
<head>
    <meta charset="utf-8">
    <title>Tambah Data Penduduk Air Haji</title>
    <!-- Tambahkan pustaka Leaflet CSS -->
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" integrity="sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A==" crossorigin="" />

    <!-- Atur ukuran peta dengan CSS -->
    <style>
       /* Atur tinggi dan lebar elemen peta */
#map {
    height: 100vh; /* Tinggi peta sesuai tinggi viewport */
    width: 100%; /* Lebar peta 100% dari kontainer */
    margin: 0;
    padding: 0;
}

/* Atur gaya untuk pop-up */
...
/* Atur gaya untuk layar kecil */
@media (max-width: 768px) {
    #map {
        height: 50vh; /* Tinggi peta setengah dari tinggi viewport */
    }
    ...
    .leaflet-popup-content img {
        max-width: 75px; /* Batasi lebar gambar pada layar kecil */
    }
}

/* Atur gaya untuk layar sangat kecil */
@media (max-width: 480px) {
    #map {
        height: 40vh; /* Tinggi peta 40% dari tinggi viewport */
    }
    ...
    .leaflet-popup-content img {
        max-width: 50px; /* Batasi lebar gambar pada layar sangat kecil */
    }
}
...
<body>
    ...
    <div class="container col-md-6 mt-4">
        <h1>Tambah Data Penduduk Air Haji</h1>
        ...
        if (isset($_POST['submit'])) {
            ...
            $query_insert_data = "INSERT INTO penduduk_air_haji (nomor_kk, kepala_keluarga, nik, jumlah_anggota, jenis_kelamin, alamat, kampung, rt, rw, tanggal_terdaftar, lat, lng, image) VALUES ('$nomor_kk', '$kepala_keluarga', '$nik', '$jumlah_anggota', '$jenis_kelamin', '$alamat', '$kampung', '$rt', '$rw', '$tanggal_terdaftar', '$lat', '$lng', '$image')";
            $result_insert_data = mysqli_query($db, $query_insert_data) or die(mysqli_error($db));

            echo "<script>alert('Data berhasil disimpan.');window.location='status_penduduk_air_haji.php';</script>";
        }
        ?>
    </div> <br><br><br>
    ...
    <script>
       var map = L.map('map').setView([-1.9295666681247163, 100.88494462345466], 13);
        ...
        if (isset($data)) {
            foreach ($data as $row) {
                ...
                echo "L.marker([$lat, $lng]).addTo(map)
                    .bindPopup(\"<h4>$kepala_keluarga</h4><p>$alamat</p> <img src='img/$image' style='width: 50px;'>\");";
            }
        }
        ?>
    </script>
