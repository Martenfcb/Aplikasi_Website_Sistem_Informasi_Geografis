...
<body>
    <div class="container col-md-6 mt-4">
        <h1>Edit Data Penduduk Air Haji Tenggara</h1>
        <?php
        include('koneksi.php');
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $query = "SELECT * FROM penduduk_air_haji_tenggara WHERE id = $id";
        ...
        if (isset($_POST['submit'])) {
            ...
            $query_update = "UPDATE penduduk_air_haji_tenggara SET 
                nomor_kk='$nomor_kk', 
            ...
            if ($result_update) {
                echo "<script>alert('Data berhasil diupdate.');window.location='status_penduduk_air_haji_tenggara.php';</script>";
            } else {
