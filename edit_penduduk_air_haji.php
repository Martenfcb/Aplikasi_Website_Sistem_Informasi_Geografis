...
<body>
    <div class="container col-md-6 mt-4">
        <h1>Edit Data Penduduk Air Haji</h1>
        <?php
        include('koneksi.php');
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
        ...
        if (isset($_POST['submit'])) {
            ...
            $query_update = "UPDATE penduduk_air_haji SET 
                nomor_kk='$nomor_kk', 
            ...
            if ($result_update) {
                echo "<script>alert('Data berhasil diupdate.');window.location='status_penduduk_air_haji.php';</script>";
            } else {
