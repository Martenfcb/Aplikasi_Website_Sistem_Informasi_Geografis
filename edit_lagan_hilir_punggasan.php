...
<body>
    <div class="container col-md-6 mt-4">
        <h1>Edit Data Penduduk Lagan Hilir Punggasan</h1>
        <?php
        include('koneksi.php');
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $query = "SELECT * FROM penduduk_lagan_hilir WHERE id = $id";
        ...
        if (isset($_POST['submit'])) {
            ...
            $query_update = "UPDATE penduduk_lagan_hilir SET 
                nomor_kk='$nomor_kk', 
            ...
            if ($result_update) {
                echo "<script>alert('Data berhasil diupdate.');window.location='status_penduduk_lagan_hilir_punggasan.php';</script>";
            } else {
